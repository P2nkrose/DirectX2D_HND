...
qStructuredBuffer::qStructuredBuffer()
	: m_Desc{}
	, m_ElementCount(0)
	, m_ElementSize(0)
...
int qStructuredBuffer::Create(UINT _ElementSize, UINT _ElementCount
...
void qStructuredBuffer::SetData(void* _pData, UINT _DataSize)
{
...
void qStructuredBuffer::GetData(void* _pData, UINT _DataSize)
{
...
void qStructuredBuffer::Binding(UINT _RegisterNum)
{
...
void qStructuredBuffer::Clear(UINT _RegisterNum)
{
...
void qStructuredBuffer::Binding_CS_SRV(UINT _RegisterNum)
{
