...
int qMesh::Create(Vtx* _VtxSysMem, UINT _VtxCount, UINT* _IdxSysMem, UINT _IdxCount)
{
	...
	m_VBDesc.ByteWidth = sizeof(Vtx) * m_VtxCount;		// 버텍스버퍼데스크의 크기
	m_VBDesc.BindFlags = D3D11_BIND_VERTEX_BUFFER;		// 버텍스버퍼의 용도
